...
Configures Stride integration for Kilo Code.

Integration Type: Root Config Only
Files Created:
- KILO.md (root config with managed block)
"""
...
class KiloConfigurator(ToolConfigurator):
    """Configurator for Kilo Code."""
