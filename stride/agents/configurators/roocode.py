"""
RooCode Configurator

Configures Stride integration for RooCode.

Integration Type: Root Config Only
Files Created:
- ROOCODE.md (root config with managed block)
"""
...
class RooCodeConfigurator(ToolConfigurator):
    """Configurator for RooCode."""
    ...
    def configure(self, project_path: Path) -> ConfigResult:
        """Create RooCode root config file."""
        messages = []
        files_created = []
