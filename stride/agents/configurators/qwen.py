...
Configures Stride integration for Qwen Code.

Integration Type: Hybrid (root config + slash commands)
Files Created:
- QWEN.md (root config with managed block)
- .qwen/prompts/stride-*.toml (9 workflow commands)
"""
...
class QwenConfigurator(ToolConfigurator):
    """Configurator for Qwen Code."""
