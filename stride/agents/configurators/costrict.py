"""
CoStrict Configurator

Configures Stride integration for CoStrict.

Integration Type: Root Config Only
Files Created:
- COSTRICT.md (root config with managed block)
"""
...
class CoStrictConfigurator(ToolConfigurator):
    """Configurator for CoStrict."""
    ...
    def configure(self, project_path: Path) -> ConfigResult:
        """Create CoStrict root config file."""
        messages = []
        files_created = []
