...
Configures Stride integration for GitHub Copilot.

Integration Type: Hybrid (root config + slash commands)
Files Created:
- COPILOT.md (root config with managed block)
- .github/copilot/stride-*.toml (9 workflow commands)
"""
...
class CopilotConfigurator(ToolConfigurator):
    """Configurator for GitHub Copilot."""
    ...
    def update(self, project_path: Path) -> ConfigResult:
        """Update GitHub Copilot integration."""
