"""
Amazon Q Developer Configurator

Configures Stride integration for Amazon Q Developer.

Integration Type: Root Config Only
Files Created:
- AMAZONQ.md (root config with managed block)
"""
...
class AmazonQConfigurator(ToolConfigurator):
    """Configurator for Amazon Q Developer."""
    ...
    def configure(self, project_path: Path) -> ConfigResult:
        """Create Amazon Q root config file."""
        messages = []
        files_created = []
